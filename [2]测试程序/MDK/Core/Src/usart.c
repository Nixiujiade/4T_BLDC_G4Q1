...
void Debug_Init(void)
{
	...
	LL_DMA_SetMemoryAddress(DMA1,LL_DMA_CHANNEL_1,(uint32_t)uart_data.rcvbuff);
	//设置接收最大数据长度
...
// 
//		LL_DMA_SetDataLength(DMA1,LL_DMA_CHANNEL_2,strlen(buffer));
//    LL_DMA_EnableChannel(DMA1,LL_DMA_CHANNEL_2);
//		
//		while(uart_data.send_ok==1);
//		uart_data.send_ok = 0;
//    return cnt;
//}
